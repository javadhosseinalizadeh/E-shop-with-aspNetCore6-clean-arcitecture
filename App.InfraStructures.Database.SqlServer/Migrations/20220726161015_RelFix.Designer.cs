...
namespace App.InfraStructures.Database.SqlServer.Migrations
{
    ...
    [Migration("20220726161015_RelFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1ccd728e-214b-4064-a02b-0e7f6fefa111"),
                            FirstName = "Javad",
                            HomeAddress = "Gilan",
                            IsActive = true,
                            LastName = "HosseinAliZadeh",
                            Password = "1234",
                            PictureFileId = 0,
                            RoleId = 1,
                        ...
                        new
                        {
                            Id = new Guid("299f89a1-a458-4a26-af6b-4559f847044e"),
                            FirstName = "Meysam",
                            HomeAddress = "Tehran",
                            IsActive = true,
                            LastName = "Hosseini",
                            ...
                            PictureFileId = 0,
                            RoleId = 2,
                            UserName = "meysam.hosseini"
                        },
                        new
                        {
                            Id = new Guid("38c90368-f90b-490a-bbac-5eeb77549154"),
                            FirstName = "Ali",
                            HomeAddress = "Gilan",
                            IsActive = true,
                            LastName = "AliZadeh",
            ...
            modelBuilder.Entity("App.Domain.Core.Entities.User", b =>
                {
                    b.HasOne("App.Domain.Core.Entities.Role", null)
                        .WithMany("User")
